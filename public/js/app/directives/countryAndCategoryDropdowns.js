app.directive('countryAndCategoryDropdowns', () => {
	return {
		...
		'</select>\n' +
		'  <input ng-model="categories[newAdForm.category].name" name="categoryName" /> ' +
		'</div>\n' +
		'<div class="field">\n' +
		...
		'	<option value="">Please select</option>' +
		'</select>\n' +
		'  <input ng-model="categories[newAdForm.category].subCategories[newAdForm.categoryChild].name" name="subCategoryName" /> ' +
		'</div>',
